...
if blockers:
    ...
    print("     git checkout -b feature/v2.0-promethease")
    print("     git add -A")
    print("     git status")
    print('     git commit -m "feat: v2.0 Promethease and SNPedia feature parity"')
    print("     git push -u origin feature/v2.0-promethease")
print()
